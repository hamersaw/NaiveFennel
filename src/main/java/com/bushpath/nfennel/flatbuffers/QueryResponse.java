...
public final class QueryResponse extends Table {
  ...
  public static int createQueryResponse(FlatBufferBuilder builder,
    ...
    QueryResponse.addId(builder, id);
    QueryResponse.addFeatures(builder, featuresOffset);
    return QueryResponse.endQueryResponse(builder);
  }

  public static void startQueryResponse(FlatBufferBuilder builder) { builder.startObject(2); }
